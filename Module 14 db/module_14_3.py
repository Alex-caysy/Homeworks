...
product_keyboard = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text='Поодукт 1', callback_data='product_buying'),
         InlineKeyboardButton(text='Поодукт 2', callback_data='product_buying'),
         InlineKeyboardButton(text='Поодукт 3', callback_data='product_buying'),
         InlineKeyboardButton(text='Поодукт 4', callback_data='product_buying')]
    ]
)
